...
function getIconForSpace(space) {
    const iconById = {
        ...
        30: `<svg viewBox="0 0 24 24" aria-hidden="true">
                <circle cx="12" cy="12" r="10" fill="#0072bb"/>
                <path d="M7 12h7.2l-2.1-2.1 1.4-1.4L18 13l-4.5 4.5-1.4-1.4 2.1-2.1H7z" fill="#fff"/>
                <rect x="4.8" y="4.8" width="5" height="5" rx="1" fill="#ed1b24"/>
            </svg>`,
